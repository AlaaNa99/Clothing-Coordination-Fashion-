...
class CLOTHES(KnowledgeEngine):
    ...
    def clothes30(self):
        self.myclothes = Myclothes(1, "darkblue", "Trousers", 0, "", "", 3, "white", "Shirt", 0, "", "", 5, "brown", "Kandra", 6,
    ...
    @Rule(AND(age(value=P(lambda value: value >= 20) & P(lambda value: value <= 60)), SkinColor(color='hanatawi'),
              Occasion('work'), Gender('male'), Person_type('business'), Season("winter")), salience=1)
    def clothes31(self):
        self.myclothes = Myclothes(1, "black", "Trousers", 0, "", "", 3, "white", "Shirt", 0, "", "", 5, "black", "Kandra", 6,
    ...
    @Rule(AND(age(value=P(lambda value: value >= 20) & P(lambda value: value <= 60)), SkinColor(color='dark'),
              Occasion('work'), Gender('male'), Person_type('business'), Season("winter")), salience=1)
    def clothes32(self):
        self.myclothes = Myclothes(1, "gray", "Trousers", 0, "", "", 3, "white", "Shirt", 0, "", "", 5, "black", "Kandra", 6,
